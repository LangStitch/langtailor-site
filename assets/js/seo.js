(function () {
  ...
  var OG_IMAGE =
    (location.hostname === "langtailor.langstitch.com"
      ...
      : SITE_ORIGIN) + "/assets/og-card.svg";
  var LOGO =
    (location.hostname === "langtailor.langstitch.com"
      ? "https://langtailor.langstitch.com"
  ...
  var VERSION = "0.2.5";
  var DOWNLOAD_URL =
    "https://github.com/LangStitch/langtailor-releases/releases/download/langtailor-v0.2.5/LangTailor-0.2.5-win-x64-setup.exe";
  ...
  var PAGES = {
    home: {
      ...
      description:
        "Design AI agents on a visual canvas. Export production code in Python, Spring AI, Go, or Rust. Free LangTailor desktop IDE + VS Code extension. MIT licensed.",
      keywords:
      ...
      jsonLd: function () {
        return [
          ...
          ORG,
          {
            ...
            description:
              "Visual agent IDE with canvas design, asset designers, RAG pipelines, and multi-language production export.",
            url: LANGTAILOR_URL,
            ...
            mainEntity: [
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text:
                    "Python (LangGraph) export ships today. Spring AI (Java), Go, and Rust exporters are on the roadmap — same canvas, same project format."
                }
              },
              {
                "@type": "Question",
    ...
    langtailor: {
      ...
      description:
        "Download LangTailor v0.2.5 — the LangStitch desktop agent IDE. Visual canvas, multi-language export, terminal, git, Docker/Helm deploy. Free MIT license.",
      keywords:
      ...
      ogDescription: "Windows & macOS · Canvas + code · Export Python, Java, Go, Rust · MIT licensed",
    ...
    try: {
      ...
      description: "Redirecting to the official LangTailor download page — free visual agent IDE for Windows and macOS.",
  ...
  var robots = page.robots || "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1";
